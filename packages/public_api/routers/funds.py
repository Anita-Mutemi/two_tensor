...
def get_published_funds(_: LoggedInUser, s: PrivateSession, query: QueryParams) -> list[FundFullSchema]: # type: ignore
...
def get_fund(_: LoggedInUser, fund_uuid: RestrictedFund, s: PrivateSession) -> FundFullSchema: # type: ignore
